...
export const BRACKET_TEMPLATE: BracketMatchTemplate[] = [
  // Round of 32 — FIFA 2026 official bracket
  mt("M73",  "round_of_32",  s2("A"),              s2("B"),              "M90",  "A"),
  mt("M74",  "round_of_32",  s1("E"),              s3("A","B","C","D","F"), "M89",  "A"),
  mt("M75",  "round_of_32",  s1("F"),              s2("C"),              "M90",  "B"),
  mt("M76",  "round_of_32",  s1("C"),              s2("F"),              "M91",  "A"),
  mt("M77",  "round_of_32",  s1("I"),              s3("C","D","F","G","H"), "M89",  "B"),
  mt("M78",  "round_of_32",  s2("E"),              s2("I"),              "M91",  "B"),
  mt("M79",  "round_of_32",  s1("A"),              s3("C","E","F","H","I"), "M92",  "A"),
  mt("M80",  "round_of_32",  s1("L"),              s3("E","H","I","J","K"), "M92",  "B"),
  mt("M81",  "round_of_32",  s1("D"),              s3("B","E","F","I","J"), "M94",  "A"),
  mt("M82",  "round_of_32",  s1("G"),              s3("A","E","H","I","J"), "M94",  "B"),
  mt("M83",  "round_of_32",  s2("K"),              s2("L"),              "M93",  "A"),
  mt("M84",  "round_of_32",  s1("H"),              s2("J"),              "M93",  "B"),
  mt("M85",  "round_of_32",  s1("B"),              s3("E","F","G","I","J"), "M96",  "A"),
  mt("M86",  "round_of_32",  s1("J"),              s2("H"),              "M95",  "A"),
  mt("M87",  "round_of_32",  s1("K"),              s3("D","E","I","J","L"), "M96",  "B"),
  mt("M88",  "round_of_32",  s2("D"),              s2("G"),              "M95",  "B"),

  // Round of 16 — FIFA 2026 official bracket
  mt("M89",  "round_of_16",  sw("M74"), sw("M77"), "M97",  "A"),
  mt("M90",  "round_of_16",  sw("M73"), sw("M75"), "M97",  "B"),
  mt("M91",  "round_of_16",  sw("M76"), sw("M78"), "M99",  "A"),
  mt("M92",  "round_of_16",  sw("M79"), sw("M80"), "M99",  "B"),
  mt("M93",  "round_of_16",  sw("M83"), sw("M84"), "M98",  "A"),
  mt("M94",  "round_of_16",  sw("M81"), sw("M82"), "M98",  "B"),
  mt("M95",  "round_of_16",  sw("M86"), sw("M88"), "M100", "A"),
  mt("M96",  "round_of_16",  sw("M85"), sw("M87"), "M100", "B"),
