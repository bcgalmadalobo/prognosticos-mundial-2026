...
const DEFAULT_DEADLINE = "2026-06-11T19:55:00.000Z";
...
export default function ConfiguracoesPage() {
  ...
  async function handleSave(e: FormEvent) {
    ...
    if (!isValidIsoDate(deadline)) {
      setError("Deadline inválida. Usa o formato ISO UTC, ex: 2026-06-11T19:55:00.000Z");
      return;
    }
