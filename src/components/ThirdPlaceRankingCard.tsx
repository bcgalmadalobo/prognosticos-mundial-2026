...
export function ThirdPlaceRankingCard({ teamIds, groupOf, onChange }: Props) {
  ...
  return (
    <div className="mt-8 rounded-2xl border border-pitch-500 bg-pitch-800 p-4 shadow-card">
      <div className="mb-4">
        <p className="text-xs font-semibold uppercase tracking-widest text-neon-500">
          Passo 2 de 4
        </p>
        <h2 className="text-xl font-bold text-pitch-50">
          Melhores terceiros classificados
        </h2>
        <p className="mt-1 text-sm text-pitch-300">
          Arrasta para ordenar os 12 terceiros. Os{" "}
          <span className="font-semibold text-neon-400">8 primeiros</span>{" "}
        ...
        <SortableContext items={teamIds} strategy={verticalListSortingStrategy}>
          <div className="flex flex-col gap-1.5">
            ...
            <div className="mb-1 flex items-center gap-2">
              <span className="rounded-full bg-brand-600/20 px-2.5 py-0.5 text-[11px] font-bold text-neon-400">
                Apurados — 8 equipas
              </span>
            </div>
            ...
            <div className="my-2 flex items-center gap-2">
              <div className="h-px flex-1 bg-pitch-500" />
              <span className="rounded-full bg-red-900/20 px-2.5 py-0.5 text-[11px] font-bold text-red-400">
